...
import CustomJobSearchTextInput from '../../../reusableComponents/CustomJobSearchTextInput/CustomJobSearchTextInput'
  ...
  return (
    <View style={styles.main}>
       ...
       <CustomBrowseJobHeader BellIconOnpress={undefined} messageIconOnpress={undefined} profileuri={require('../../../assets/images/person.jpg')}/>
         {/* search and filter  */}
         <CustomJobSearchTextInput onRightIconPress={()=> navigation.navigate(MainRoutes.BROWSE_JOB_CANDIDATE_FILTER_SCREEN) } rightIcon={<Svg.FilterIcon/>}/>     {/* need to change dropdown with country and pass data using props */}
